...
GAME.Explosion = function()
{
	...
	// first build it..
	this.top = 	new ExplosionPartical("asplodeInner02.png");//this.particalPool.getObject();
...
GAME.Explosion.prototype.updateTransform = function()
{
	...
	if(this.exploding)
	{
		for (var i=0; i < this.clouds.length; i++) 
		{
			...
			{
				//cloud.alpha *= 0.99;
				//cloud.scale.y = cloud.scale.x *= 1.001
...
{
	PIXI.Sprite.call(this, PIXI.Texture.fromFrameId(id));
	this.anchor.x = 0.5;
	this.anchor.y = 0.5;
